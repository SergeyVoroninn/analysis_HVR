...
|   app_constants.py               Централизованные константы: имена файлов, расширения, сентинелы, пороги импорта/сортировки, тайминги кликов и зума, метрики качества ЭКГ (замена хардкода)
