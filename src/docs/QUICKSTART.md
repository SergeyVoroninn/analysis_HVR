...
7. [Настройка тестового профиля атлета](#настройка-тестового-профиля-атлета)
8. [Настройка профиля ЭКГ](#настройка-профиля-экг)
9. [Ручной чек-лист (GUI)](#ручной-чек-лист-gui)
10. [Автотесты](#автотесты)
11. [Сборка EXE](#сборка-exe)
12. [Клонирование профиля из реальной записи](#клонирование-профиля-из-реальной-записи)
...
### Жесты управления графиками ТР и стресса

| Жест | Действие |
| --- | --- |
| Окно | — |
| Колесо | Свободный зум: от 0.5 недели до всего диапазона базы |
| Перетаскивание | Свободная панорама |
| Клик по heatmap | Центровка на неделе (с подгонкой к данным атлета) |
| Двойной клик по бару | Календарный год ∩ данные атлета |
| ПКМ | Весь период выбранного атлета (поля −0.5/+1.0 недели) |
| Смена спортсмена | Масштаб не меняется |
