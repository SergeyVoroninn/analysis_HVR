...
| Двойной клик | Зум до календарного года кликнутого столбика + переключение yearmap на этот год |
| ПКМ | Сброс на весь период выбранного атлета |
...
| Клик по пустой ячейке | Ничего не происходит |

### Шкала X (синхронизирована с зеброй фона)

| Масштаб | Зебра | Подписи оси |
| --- | --- | --- |
| > 120 дней | По месяцам | Январь — год, остальные — месяц («фев», «мар», …) |
| 14–120 дней | По неделям | Дата.месяц («15.03») |
| ≤ 14 дней | По дням | День недели («Пн», «Вт», …) |

> Первая неполная полоса слева (когда начало диапазона не совпадает с границей
> периода) не подписывается — её дата указана в заголовке графика.
