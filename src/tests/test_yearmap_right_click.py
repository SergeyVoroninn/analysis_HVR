"""
Тест ПКМ по yearmap: проверка установки масштаба на год,
синхронизации курсора weekmap и сохранения состояния при смене атлетов.
"""
import datetime
import os
import sys
...
def test_yearmap_right_click_sync_and_persistence(gui_root):
    """
    Сценарий:
    ...
    5. Проверяем, что ВСЕ три состояния НЕ "уплыли".
    """
    root = gui_root
    ...
    print("✅ Тест пройден: ПКМ по yearmap синхронизирует zoom и weekmap, и состояние сохраняется")